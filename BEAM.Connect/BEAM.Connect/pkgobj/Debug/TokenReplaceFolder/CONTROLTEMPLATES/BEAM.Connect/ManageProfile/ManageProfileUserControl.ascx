            ...
            <asp:Panel ID="distributorPnl" runat="server" Visible="false">
                ...
                <div class="row">
                    ...
                    <span class="field">
                        ...
                        <asp:RequiredFieldValidator ID="rvOnOffPremise" runat="server" ControlToValidate="onOffPremiseDDL" InitialValue="" ErrorMessage="Please provide us with your area" Display="Dynamic" CssClass="validationMsg" ValidationGroup="registration" />
                    </span>
                </div>
            </asp:Panel>
            <div class="row">
