...
namespace GraphApi
{
    public class B2CGraphClient
    {
        ...
        internal AuthenticationContext authContext;
        internal ClientCredential credential;
...
#if PROD
            json = json.Replace("a67c327875c34024bd4523a3d66619ba", "be6dc6c96b4c411780751b4231962926");
#endif
