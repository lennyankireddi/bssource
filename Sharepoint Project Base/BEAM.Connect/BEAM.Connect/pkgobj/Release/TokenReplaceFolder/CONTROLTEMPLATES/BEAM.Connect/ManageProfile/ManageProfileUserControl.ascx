        ...
        <asp:Panel ID="manageProfilePnl" CssClass="form manageprofile" runat="server">
            ...
            <div class="row">
                ...
                <span class="field">
                    ...
                    <asp:CustomValidator ID="ageValid" runat="server" ValidationGroup="registration" ControlToValidate="birthdayTxt" OnServerValidate="ageValid_ServerValidate" ErrorMessage="You must be 21 or older to use Connect" Display="Dynamic" />
                </span>
            </div>
            <div class="row">
