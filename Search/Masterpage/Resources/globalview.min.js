...
function RichDocumentSearch(e) {
	...
	var searchUrl = "/_api/search/query?querytext='((filename:" + t + ") OR (brand:" + t + ") OR (beamconnectcategory:"+ t +")) AND (isDocument:true) -contenttype:program'&selectproperties='Path,ServerRedirectedURL,Title,FileName,FileExtension'";
	var searchTerm = t;
	console.log("Home page search term: " + searchTerm);
